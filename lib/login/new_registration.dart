...
import 'login_using_password.dart';
    ...
    try {
      ...
      if (isLogin) {
        ...
        authResult = (await _auth.createUserWithEmailAndPassword(
            ...
            context,
            MaterialPageRoute(builder: (context) =>
            PasswordLogin(controller: _emailController)
    ),
    );
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Text("Enter your Details to create account",
                    style: TextStyle(
